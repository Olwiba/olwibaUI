...
import { ModeSwitcher, SearchButton } from '@olwiba/docs';
      ...
      <div className="flex h-full w-full max-w-[1400px] items-center gap-2 border-r border-l border-dashed px-4 md:mx-auto md:gap-5 md:px-6">
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <div className="relative overflow-visible">
            <a
              href="https://github.com/olwiba/olwibaUI"
              target="_blank"
            ...
            <span className="absolute -right-2 -top-2 rotate-12 bg-purple-500 px-1.5 pt-0.5 pb-1 text-[8px] font-bold text-white rounded-xs">
              soon
            </span>
          </div>
          <ModeSwitcher />
