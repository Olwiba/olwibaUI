...
`layout="carousel"` renders the same cards in a scroll-snap [Carousel](/docs/components/carousel) with prev/next controls. To carousel your own content outside a section, use the `Carousel` mechanic directly.
