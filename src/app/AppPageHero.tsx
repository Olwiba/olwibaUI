...
export function AppPageHero({
  ...
  return (
    <section
      className={cn(
        'relative overflow-hidden border bg-card/80 shadow-sm',
        // Compact is the page-pattern header: same surface and glow, less bulk,
        // so it introduces a route without eating the fold above dense content.
